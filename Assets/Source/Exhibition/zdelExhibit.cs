...
{
    public class zdelExhibit : MonoBehaviour
    {
        ...
        /// <returns></returns>
        public static zdelExhibit Create(GameObject owner, GameObject prefab, ArtifactInfo info)
        {
            GameObject temp = GameObject.Instantiate(prefab, owner.transform);
            temp.transform.localPosition = Vector3.zero;
            zdelExhibit exhibit = temp.GetComponent<zdelExhibit>();
            exhibit.m_info = info;
            return exhibit;
        }
